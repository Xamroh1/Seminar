...
for a in range(anzahl_instanzen):
    
    Depot, Kunden_Koord, Ladestationen_Koord, Kundenmatrix, Depotdistanzen, KundenLadenMatrix, Batterie = instanzengenerierung(anzahl_kunden,anzahl_ladesaeulen)

    #Instanzenspeicherung
